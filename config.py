...
PHASES = {
    "phase1": {
        ...
        "instructions": """The user will summarize the shared case study. Please critically review their response for accuracy. You will give them credit for mentioning ecommerce, and you will be very pleased if they mention it is about ecommerce with any other relevant details.""",
        "value": " ",
        "scored_phase": True,
        "rubric": """
            1. About
...
ASSISTANT_NAME = "assistant_vl"
ASSISTANT_INSTRUCTIONS = """ You are providing feedback on a user's understanding of a shared case study about ecommerce. The case study has been uploaded to the file search for shared reference by you and the student.  """
